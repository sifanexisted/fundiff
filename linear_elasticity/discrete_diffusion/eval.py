...
from model_utils import create_train_step, create_encoder_step, create_decoder_step, create_eval_step, create_autoencoder_state
...
def evaluate(config: ml_collections.ConfigDict):
    ...
    for i in tqdm(range(z1_list.shape[0] // batch_size)):
        ...
        u_pred = decoder_step(state.params[1], new_z1)
